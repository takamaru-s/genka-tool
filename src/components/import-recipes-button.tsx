...
const TEMPLATE_CSV =
  "レシピ名,説明,仕込み量,仕込み単位,食材名,使用量\r\n" +
  "ミートソース,ボロネーゼ用,1000,g,牛ひき肉,300\r\n" +
  "ミートソース,ボロネーゼ用,1000,g,玉ねぎ,200\r\n" +
  "ミートソース,ボロネーゼ用,1000,g,トマト缶,400\r\n" +
  "ハンバーグ,,150,g,牛ひき肉,100\r\n" +
  "ハンバーグ,,150,g,玉ねぎ,50\r\n";

type Result = { created: number; updated: number; skipped: number; errors: string[] };

export function ImportRecipesButton() {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 p-6">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-bold text-gray-900">レシピCSVインポート</h2>
            ...
            <div className="mb-4 p-3 bg-blue-50 rounded-lg text-sm text-blue-800">
              ...
              <code className="text-xs">レシピ名,説明,仕込み量,仕込み単位,食材名,使用量</code>
              <p className="text-xs mt-1 text-blue-600">※ 同一レシピ名の行をまとめて1レシピとして取り込みます。食材は先に登録してください。</p>
              <button
            ...
            {/* 重複時の動作 */}
            <div className="mb-5">
              <label className="block text-sm font-medium text-gray-700 mb-2">同名のレシピが既にある場合</label>
